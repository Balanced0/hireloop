          ...
          <Card>
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-white/3 border border-white/8 rounded-xl">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-[#6366F1]/10 border border-[#6366F1]/20 flex items-center justify-center">
                    <OfficeBadge className="w-4 h-4 text-[#818CF8]" />
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      {company.plan} plan · {company.activeJobs ?? 0} /{" "}
                      {company.jobLimit ?? 3} active jobs used
                    </p>
                  </div>
                </div>
                {company.approved ? (
                  <span className="flex items-center gap-1 text-xs text-green-400 bg-green-400/10 border border-green-400/20 px-2.5 py-1 rounded-lg">
                    <CircleCheckFill className="w-3 h-3" /> Approved
                  </span>
                ) : (
                  <span className="flex items-center gap-1 text-xs text-yellow-400 bg-yellow-400/10 border border-yellow-400/20 px-2.5 py-1 rounded-lg">
                    <CircleInfoFill className="w-3 h-3" /> Pending approval
                  </span>
                )}
              </div>
            ) : (
            ...
            {company && company.activeJobs >= company.jobLimit && (
              <div className="mt-3 px-4 py-3 bg-yellow-500/5 border border-yellow-500/20 rounded-xl text-sm text-yellow-400 flex items-center gap-2">
                ...
                {company.jobLimit} jobs). Upgrade to post more.
              </div>
            )}
          </Card>
